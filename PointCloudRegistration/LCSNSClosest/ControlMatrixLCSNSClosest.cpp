...
CControlMatrixLCSNSClosest::CControlMatrixLCSNSClosest(void)
	: m_pPointCloud(NULL)
{
...
//*********************************************************************************
//FUNCTION:
void CControlMatrixLCSNSClosest::__genControlPointsMatrix( const SamplePointSet& vSamplePointSet, PtrSimpleCtrlPntSet& voCtrlPntsSet ) const
{
...
//*********************************************************************************
//FUNCTION:
void hiveRegistration::CControlMatrixLCSNSClosest::genControlPointsMatrix(const hivePointCloud::CPointCloud* vPointCloud, PtrSimpleCtrlPntSet& voCtrlPntsSet)
{
	_ASSERT(vPointCloud);
...
//*********************************************************************************
//FUNCTION:
void hiveRegistration::CControlMatrixLCSNSClosest::__computeRegion( const Eigen::Matrix<double, 3, Eigen::Dynamic>& vPointSet, RegionDim3& voRegion ) const
{
...
//*********************************************************************************
//FUNCTION:
void CControlMatrixLCSNSClosest::__initControlPointsMatrix( const SamplePointSet& vSamplePointSet, VecCandCtrlPnts& voCandCtrlPntsSet ) const
{
...
//#pragma parallel omp		//FIXME: is omp safe here?
...
//*********************************************************************************
//FUNCTION:
void hiveRegistration::CControlMatrixLCSNSClosest::__initNewCoordinates( const ColVector3& vNormal, ColVector3& voNewCoordinateAxisX, ColVector3& voNewCoordinateAxisY, ColVector3& voNewCoordinateAxisZ ) const
{
...
//*********************************************************************************
//FUNCTION:
void hiveRegistration::CControlMatrixLCSNSClosest::__removeRedundantPoints(VecCandCtrlPnts& vCandCtrlPntsSet, PtrSimpleCtrlPntSet& voCtrlPntsSet) const
{
	if (!voCtrlPntsSet.get())
	{
		voCtrlPntsSet.reset(new SimpleCtrlPntSet);
	}
	voCtrlPntsSet->clear();
...
//#pragma parallel for
	for (int s=0; s<SizeCtlPntsSet; ++s)
	{
			...
			for (int k=0; k<m_CtrlMatCol; ++k)
			{
				...
				if (CurPntSetSize > 1)
				{
					if (0 == m_MatrixGenerationType)
					{
						...
						TmpPntSet(i, k) = MatLocal2World * vCandCtrlPntsSet[s](i, k)[RandomIndex] + CoordsOrigin;
					}
					else
					{
						...
						TmpPntSet(i, k) = MatLocal2World * vCandCtrlPntsSet[s](i, k)[IndexMinDist] + CoordsOrigin;
					}
		...
		{
			voCtrlPntsSet->push_back(TmpPntSet);
...
//*********************************************************************************
//FUNCTION:
void hiveRegistration::CControlMatrixLCSNSClosest::__parseConfig( void )
{
...
//*********************************************************************************
//FUNCTION:
void hiveRegistration::CControlMatrixLCSNSClosest::__setCoordOrigin( const std::vector<unsigned int>& vPointSet, ColVector3& voOrigin, ColVector3& voNormal ) const
{
	double XYZ[3] = {0, 0, 0};
	const double* pPos = m_pPointCloud->getPosPointer();
